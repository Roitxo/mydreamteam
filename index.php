...
<html lang="en">
  <head>
    ...
    />
    <link
      href="https://fonts.googleapis.com/css?family=Montserrat|Roboto+Condensed&display=swap"
      rel="stylesheet"
    />
  ...
  <body>
    ...
    <div class="jumbotron jumbotron-fluid jumbo-home">
      <div class="container">
        ...
        <button class="btn btn-success">Create my XI</button>
      </div>
    </div>
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-3 transparent">
          <div
            ...
            class="carousel slide carousel-card"
            data-ride="carousel"
          >
            ...
            <div class="carousel-inner card-slider">
              <div class="carousel-item active">
                <img
                  class="d-block w-100 card-slider"
                  src="img/centrocampistas/Kaka.jpg"
                  alt="First slide"
                />
              </div>
              ...
              <div class="carousel-item card-slider">
                <img
                  ...
                  src="img/defensas/Cannavaro.jpg"
                  alt="Third slide"
                />
              </div>
            </div>
